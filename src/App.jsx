  ...
  <main>
    ...
    <section id='section-1'>
      <nav>
        ...
        <div className="nav-elem">
          <i className="ri-arrow-right-s-line"></i>Our Show Reel</div>
        <div className="nav-elem">
...
of art, design and technology.
    ...
    <section id='section-3'>
      <div className="top">
        <div className="left">
          <h3>
            Lorem ipsum dolor <br/>sit amet consectetur <br/> adipisicing elit.<br/> Enim, tempora!
          </h3>
        </div>
        <div className="right"></div>
      </div>
    ...
    <section id="section-4">
       <div className="bottom">
        <div className="left"></div>
        <div className="right">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, saepe necessitatibus quibusdam tenetur cupiditate vero adipisci quisquam iure sapiente perspiciatis fugit quasi hic reiciendis laboriosam molestias illo voluptatum enim tempora!</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, saepe necessitatibus quibusdam tenetur cupiditate vero adipisci quisquam iure sapiente perspiciatis fugit quasi hic reiciendis laboriosam molestias illo voluptatum enim tempora!</p>
